...
public partial class ItemsView : UserControl
{
    ...
    private void EditarSeleccionado()
    {
        ...
        {
            MessageBox.Show(Window.GetWindow(this) ?? System.Windows.Application.Current.MainWindow, "Seleccioná un ítem de la lista.", "CLAMM", MessageBoxButton.OK, MessageBoxImage.Information);
            return;
        }

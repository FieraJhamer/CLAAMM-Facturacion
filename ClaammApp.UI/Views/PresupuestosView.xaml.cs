...
public partial class PresupuestosView : UserControl
{
    ...
    private void AbrirSeleccionado()
    {
        ...
        {
            MessageBox.Show(Window.GetWindow(this) ?? System.Windows.Application.Current.MainWindow, "Seleccioná un presupuesto de la lista.", "CLAAMM", MessageBoxButton.OK, MessageBoxImage.Information);
            return;
        }
    ...
    private void BtnExportar_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show(Window.GetWindow(this) ?? System.Windows.Application.Current.MainWindow, "No se pudo generar el PDF: " + ex.Message, "CLAAMM", MessageBoxButton.OK, MessageBoxImage.Error);
        }
    }
}
